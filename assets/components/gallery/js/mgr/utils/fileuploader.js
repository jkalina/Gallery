...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
                ...
                '<img style="display: none" id="source-img" />' +
                '<img style="display: none" id="result-img" />' +
             '</div>',
...
qq.extend(qq.UploadHandlerXhr.prototype, {
    ...
    _upload: function(id, params){
        ...
        console.log('original', file, name, size, id);

        var sourceImage = document.getElementById('source-img');
        ...
        reader.onload = function(event) {
            ...
            sourceImage.onload = function(){
                ...
                //TODO: get extension from name variable
                resultImage.src = jic.compress(sourceImage,10,"jpg").src;

                var cvs = document.createElement('canvas');
                cvs.width = resultImage.naturalWidth;
                cvs.height = resultImage.naturalHeight;
                var ctx = cvs.getContext("2d").drawImage(resultImage, 0, 0);
                ...
                params = params || {};
                params['qqfile'] = name;
                var queryString = qq.obj2url(params, self._options.action);
                ...
                xhr.sendAsBinary(['--' + boundary, 'Content-Disposition: form-data; name="qqfile"; filename="' + name + '"', 'Content-Type: ' + type, '', atob(data), '--' + boundary + '--'].join('\r\n'));
